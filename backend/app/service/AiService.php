...
【写作风格要求】
请运用"巴纳姆效应"的语言技巧，让解读更有代入感和共鸣感：
1. 多用"你"开头，增强第二人称代入感
2. 描述内心矛盾：先说一个特质，再说"但有时候你也会..."的反面，让人觉得被深度理解
3. 使用模糊但有感染力的表达，如"你有一种难以言说的..."、"在某些时候你会..."
4. 加入"潜力暗示"：告诉对方他有未被发掘的潜力
5. 避免过于绝对的负面表述，将缺点转化为"需要注意的地方"或"成长空间"
6. 每个方面都要有"这一点你自己心里其实清楚"或"你可能也有所感受"这类让人产生共鸣的句子

请从以下方面进行分析：
1. 日主特性与性格分析（重点体现内心矛盾感和潜力暗示）
2. 事业发展方向建议（给出具体方向，但用"往往"、"更容易"等模糊词）
3. 财运分析（正面为主，将不足转化为"需要更多积累"）
4. 感情婚姻分析（强调"真正的连接"和"被理解"的渴望）
5. 健康注意事项（用"你的情绪状态对身体影响比一般人更大"这类普遍共鸣）
6. 近期运势提醒（给出积极暗示，让人觉得"时机快到了"）

请用通俗易懂但有深度感的语言，给出具体实用的建议。
PROMPT;
    }
