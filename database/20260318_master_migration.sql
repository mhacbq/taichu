...
SELECT '▶ [13/15] 缺失表创建（合婚/塔罗/六爻/系统配置等22张表）...' AS migration_step;
SOURCE 20260318_create_missing_tables.sql;

SELECT '▶ [14/16] 高频查询与清理索引补齐...' AS migration_step;
...
SELECT '▶ [15/16] 合婚功能积分配置写入 system_config...' AS migration_step;
SOURCE 20260318_fix_hehun_points_config.sql;

SELECT '▶ [16/16] 神煞历史乱码数据回填...' AS migration_step;
